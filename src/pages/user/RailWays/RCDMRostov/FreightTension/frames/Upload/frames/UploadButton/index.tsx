...
import { setRetreats as setRetreatsAC, setKilometers as setKilometersAC, setCargos as setCargosAC, setFileValidationErrors as setFileValidationErrorsAC } from "src/state/redux/features/RCDMRostov/FreightTension/actionCreators";
  ...
  const onBookSelect = (e: ChangeEvent<HTMLInputElement>) => {
    ...
    if (selectedFile) {
      ...
      reader.onload = function (event: ProgressEvent<FileReader>) {
        ...
        validationErrors = fileValidator.sheetsValidate(workBook.Sheets["Отступления"], workBook.Sheets["Оценка КМ"], workBook.Sheets["Грузо"], workBook.SheetNames);
