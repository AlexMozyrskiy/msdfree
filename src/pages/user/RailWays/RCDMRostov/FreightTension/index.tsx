  ...
  return (
    <section className={st.video}>
      ...
      <div className={st.video__content}>
        <Switch>
          {tagsRoutes.map((route) => role?.includes(route.availableRole) && <Route exact={route.exact} path={route.path} component={route.component} key={route.path} />)}
